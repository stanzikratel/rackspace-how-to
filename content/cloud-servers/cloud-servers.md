...
<p class="lead" markdown="1">This Getting Started Guide covers everything you'll need to know as a new Rackspace customer, including how to manage your account, create servers, set up security, and schedule server imaging.</p>
